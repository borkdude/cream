...
- Java lambdas across classloader boundaries crash with `LambdaConversionException` ("Type mismatch ... is not a subtype of itself"). This is caused by missing `InvokeGeneric` support in Crema's interpreter — fixed by [GH-13175](https://github.com/oracle/graal/pull/13175) (merged 2026-03-19, NOT in ea18, expected in ea19). Blocks commonmark-java, flexmark-java, nextjournal.markdown. Retry these when ea18 is available.
